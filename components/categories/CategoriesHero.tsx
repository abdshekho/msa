import { FaBoxOpen, FaPhoneAlt, FaRegArrowAltCircleDown, FaSolarPanel, FaTools } from 'react-icons/fa';
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between">
                    <div className="w-full lg:w-1/3 mb-10 md:mb-0 mt-[-150px] md:mt-0" style={ { direction: lang === 'en' ? "ltr" : "rtl" } }>
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-4">
                            <Link href={'products'} className="group flex items-center shadowText-b bg-primary  hover:bg-primary-10 text-white text-sm shadow-2xl md:text-base font-bold p-3 md:py-3 md:px-6 rounded-lg transition-all">
                                <FaBoxOpen className='shadowIcon group-hover:rotate-12 transition-transform mx-2' />
                                { lang === 'en' ? "Our products" : "تصفح منتجاتنا" }
                            </Link>
                            <a href={'#categoriesHeader'} className="flex items-center border shadowText-b border-white  hover:bg-[#053862] text-sm  md:text-base font-bold p-3 md:py-3 md:px-6 rounded-lg transition-all duration-300">
