                ...
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between">
                    <div className="w-full lg:w-1/3 mb-10 md:mb-0">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button className="bg-[#d28711] hover:bg-yellow-600 text-sky-900 font-bold py-3 px-6 rounded-lg transition duration-300">
                                Get a Free Quote
                            </button>
                            <button className="bg-transparent hover:bg-white hover:text-sky-900 text-white font-bold py-3 px-6 border-2 border-white rounded-lg transition duration-300">
                                Learn More
                            </button>
                        </div>
                    </div>
